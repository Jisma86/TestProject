...
public class ExplicitWaitClass {
	...
	public void presenceOfElementLocatedWaitName(WebDriver driver,String locatorValue)
	{
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofMillis(5));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.name(locatorValue)));
	} 
	
	public void presenceOfElementLocatedWaitClassName(WebDriver driver,String locatorValue)
	{
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofMillis(5));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.className(locatorValue)));
	} 
	
	public void presenceOfElementLocatedWaitCssSelector(WebDriver driver,String locatorValue)
	{
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofMillis(5));
